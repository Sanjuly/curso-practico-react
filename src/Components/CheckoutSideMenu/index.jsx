...
const CheckoutSideMenu = () => {
    ...
    return (
        <aside 
            className={`${context.isCheckoutSideMenuOpen ? "flex" : "hidden"} checkout-side-menu flex-col fixed right-2 border border-black rounded-lg bg-white scrollable-cards`}>
